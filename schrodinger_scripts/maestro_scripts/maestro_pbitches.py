...
from schrodinger.structutils import transform, analyze
...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.anchor_center_to_origin_button = QPushButton('Box center to origin (Desmond)')
        self.anchor_center_to_origin_button.clicked.connect(self.on_clicked_center_to_origin_button)
    ...
    def set_defaults(self):
        ...
        try:
            ...
            MBox = QMessageBox()
            MBox.setText('The selected structure does not have PBC properties, create periodic system?')
    ...
    def on_clicked_center_to_origin_button(self):
        x, y, z = self.lattice_a_le.text(), self.lattice_b_le.text(), self. lattice_c_le.text()
